...
.v82-vehicle-mark{display:flex;align-items:center;gap:8px;flex:0 0 auto}.v82-brand-logo{width:72px;height:52px;border-radius:12px;background:#fff;display:grid;place-items:center;padding:6px;box-sizing:border-box;box-shadow:inset 0 0 0 1px #d8e4ee,0 4px 10px #17324b18}.v82-brand-logo img{display:block;max-width:100%;max-height:100%;object-fit:contain}.v82-ev-badge{display:inline-flex;align-items:center;white-space:nowrap;padding:6px 8px;border-radius:12px;background:#e7f8ff;border:1px solid #76c9e8;color:#07577a;font-size:11px;font-weight:1000}.v82-logo-fallback{margin:0}.v75s-logo{width:46px;height:46px;border-radius:12px;background:#fff;color:#0d3153;display:grid;place-items:center;font-size:28px;font-weight:1000;font-style:italic;box-shadow:inset 0 -4px 0 #dce5ec,0 4px 10px #0003}
