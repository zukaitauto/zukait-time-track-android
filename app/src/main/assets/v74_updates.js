...
function v84SupervisorPanels(root){
 ...
 const items=[job,assigned,add,inc,id001].filter(x=>x&&x.isConnected);
...
.v93-rpm-needle{position:absolute;z-index:2;left:50%;bottom:50%;width:3px;height:38%;border-radius:3px;background:var(--g);transform-origin:50% 100%;transform:rotate(calc(-135deg + min(var(--pct,0),100)*2.7deg));box-shadow:0 0 6px color-mix(in srgb,var(--g) 55%,transparent);opacity:.8}
.v93-rpm-hub{position:absolute;z-index:3;left:50%;top:50%;width:10px;height:10px;margin:-5px;border-radius:50%;background:#fff;border:3px solid var(--g);box-sizing:border-box}
.v80-rpm-gauge .v80-gauge-inner{margin-top:25px}.v80-rpm-gauge .v80-gauge-title{font-size:10px;letter-spacing:.08em}.v80-rpm-gauge b{font-size:27px!important;margin:6px 0 4px!important}.v80-rpm-gauge small{font-size:11px!important;font-weight:1000!important;letter-spacing:.04em}
...
`;document.head.appendChild(st);
   ...
   if(active&&aa){
     runningHtml+='<div class="v75s-hero"><div><div class="v75s-jno">JOB NUMBER : <b>'+esc(active.job)+'</b></div><div class="v75s-vehicle">'+esc(hold?'IDEAL TIME':(j.vehicle||'—'))+'</div><div class="v75s-reg">'+esc(hold?'Waiting / No Assigned Work':(j.reg||'—'))+'</div></div>'+(hold?'<div class="v75s-gear" style="margin-left:auto">◷</div>':vehicleBadge(j.vehicle))+'</div>'+
       '<div class="v75s-timepair"><div id="v80RunningGauge" class="v80-gauge v80-rpm-gauge v80-green"><span class="v93-rpm-redline"></span><span class="v93-rpm-needle"></span><span class="v93-rpm-hub"></span><div class="v80-gauge-inner"><span class="v80-gauge-title">RUNNING TIME</span><b id="v75sRunning">'+esc(running)+'</b><small id="v80RunningPct">0% USED</small><span class="v80-start">Started '+esc(startTime)+'</span></div></div><div id="v80RemainingGauge" class="v80-gauge v80-rpm-gauge v80-green"><span class="v93-rpm-redline"></span><span class="v93-rpm-needle"></span><span class="v93-rpm-hub"></span><div class="v80-gauge-inner"><span id="v80RemainingTitle" class="v80-gauge-title">'+(sg>0?'REMAINING TIME':'NO ALLOCATED TIME')+'</span><b id="currentRemaining">'+(sg>0?fm(remain):'—')+'</b><small id="v80RemainingPct">'+(sg>0?'100% LEFT':'SET TIME')+'</small></div></div></div>'+
