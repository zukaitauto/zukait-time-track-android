...
`;document.head.appendChild(st);
   ...
   const progress='<div class="v104-month-progress"><div class="v104-progress target"><span>MONTHLY TARGET</span><b>'+fm(+monthInc.target||0)+'</b></div><div class="v104-progress achieved"><span>MONTHLY ACHIEVED</span><b>'+fm(+monthInc.eligible||+monthInc.actual||0)+'</b></div></div>'; const month='<div class="card month-summary v75s-section"><div class="section-title"><h3>📅 This Month</h3><span class="pill">MONTHLY</span></div>'+progress+'<div class="v81-month-grid">'+orb('v81-m1',String(normalDone.length),'Completed Jobs')+orb('v81-m2',eff==null?'—':eff.toFixed(1)+'%','Efficiency')+orb('v81-m3',fm(monthSuggested),'Suggested Time')+orb('v81-m4',fm(monthActual),'Actual Time')+orb('v81-m5',fm(Math.abs(monthRemaining)),monthRemaining>=0?'Remaining Time':'Over Suggested')+orb('v81-m6',fm(idealMin),'Ideal Time')+orb('v81-m7',fm(overtimeMin),'Overtime')+'</div></div>';
