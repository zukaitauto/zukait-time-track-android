...
.v75s-live.off{background:linear-gradient(145deg,#fff7d6,#ffd98a);border-color:#efb83f!important;color:#6b4300;box-shadow:inset 0 3px 8px #fff9,0 7px 18px #d89a2538!important}.v75s-live.off .v75s-gear{background:#fff4c7;color:#b45309;box-shadow:inset 0 -4px 8px #f59e0b18,0 4px 12px #b4530928}.v75s-live.off h2{color:#9a4b00;letter-spacing:.02em}.v75s-live.off p{color:#704b12;font-weight:800}.v75s-gear{width:54px;height:54px;border-radius:50%;display:grid;place-items:center;background:#fff8;font-size:28px;box-shadow:inset 0 -4px 8px #0001,0 4px 10px #0001}.v75s-live h2{margin:0;font-size:22px}.v75s-live p{margin:4px 0 0;font-size:13px}
