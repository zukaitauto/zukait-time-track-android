...
(function(){'use strict';
 ...
 window.renderEmployee=function(){
   ...
   const car=()=>'<div class="v75s-car" aria-hidden="true"><span class="v80-generic-car">🚘</span></div>';
   const vehicleBrand=v=>{const s=String(v||'').toLowerCase();const brands=[[/mercedes|benz|c[ -]?class|e[ -]?class|s[ -]?class/,'Mercedes-Benz','MB'],[/\bbmw\b/,'BMW','BMW'],[/range rover|land rover/,'Land Rover','LR'],[/\blexus\b/,'Lexus','L'],[/\btoyota\b|camry|corolla|land cruiser|prado/,'Toyota','T'],[/\bnissan\b|patrol|x-?trail|rogue/,'Nissan','N'],[/\binfiniti\b/,'Infiniti','I'],[/\bporsche\b/,'Porsche','P'],[/\baudi\b/,'Audi','A'],[/volkswagen|\bvw\b/,'Volkswagen','VW'],[/\bvolvo\b/,'Volvo','V'],[/\bhonda\b/,'Honda','H'],[/mitsubishi/,'Mitsubishi','M'],[/\bmazda\b/,'Mazda','MZ'],[/\bford\b/,'Ford','F'],[/chevrolet|\bchevy\b/,'Chevrolet','CH'],[/\bgmc\b/,'GMC','GMC'],[/\bjeep\b/,'Jeep','J'],[/\bdodge\b/,'Dodge','D'],[/\bhyundai\b/,'Hyundai','H'],[/\bkia\b/,'Kia','K']];for(const b of brands)if(b[0].test(s))return{name:b[1],mark:b[2]};return null};
   const vehicleBadge=v=>{const b=vehicleBrand(v);return b?'<div class="v80-brand-badge" title="'+esc(b.name)+'"><b>'+esc(b.mark)+'</b><small>'+esc(b.name)+'</small></div>':car()};
...
`;document.head.appendChild(st);
   ...
   if(active&&aa){
     runningHtml+='<div class="v75s-hero"><div><div class="v75s-jno">JOB NUMBER : <b>'+esc(active.job)+'</b></div><div class="v75s-vehicle">'+esc(hold?'IDEAL TIME':(j.vehicle||'—'))+'</div><div class="v75s-reg">'+esc(hold?'Waiting / No Assigned Work':(j.reg||'—'))+'</div></div>'+(hold?'<div class="v75s-gear" style="margin-left:auto">◷</div>':vehicleBadge(j.vehicle))+'</div>'+
       '<div class="v75s-timepair"><div id="v80RunningGauge" class="v80-gauge v80-green"><div class="v80-gauge-inner"><span class="v80-gauge-title">RUNNING TIME</span><b id="v75sRunning">'+esc(running)+'</b><small id="v80RunningPct">0% USED</small><span class="v80-start">Started '+esc(startTime)+'</span></div></div><div id="v80RemainingGauge" class="v80-gauge v80-green"><div class="v80-gauge-inner"><span id="v80RemainingTitle" class="v80-gauge-title">REMAINING TIME</span><b id="currentRemaining">'+fm(remain)+'</b><small id="v80RemainingPct">100% LEFT</small></div></div></div>'+
