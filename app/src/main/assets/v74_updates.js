...
window.v132OpenSupervisorVehicleEdit=function(no){
 ...
 const body='<div class="notice"><b>Job Card:</b> '+v74JLE(j.no)+'</div><div class="grid"><label>Make<br><input id="v132SupMake" value="'+v74JLE(guessedMake)+'"></label><label>Model<br><input id="v132SupModel" value="'+v74JLE(guessedModel)+'"></label><label>Year<br><input id="v132SupYear" inputmode="numeric" maxlength="4" value="'+v74JLE(j.year||'')+'"></label><label>Registration Number<br><input id="v132SupReg" value="'+v74JLE(j.reg||'')+'"></label></div><div class="notice small">Only vehicle details are changed. Job Card number, technicians and work-time history remain unchanged.</div><p><button class="green" onclick="v132SaveSupervisorVehicleEdit(\''+v74JLE(j.no)+'\')">SAVE CHANGES</button></p>';
