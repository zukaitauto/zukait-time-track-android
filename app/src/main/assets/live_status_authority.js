(function(){'use strict';
  ...
  function workerTable(list,title){
    ...
    const close='<button type="button" data-active-workers-close="1" aria-label="Close Active Workers" onclick="closeActiveWorkersPopup()" style="margin-left:auto;min-width:42px;min-height:38px;padding:4px 12px;border-radius:10px;font-size:20px;font-weight:900">×</button>';
