...
const x=state.active&&findPL(state.active);if(x&&p.completion){const applied=p.completion.apply(x);Object.assign(x,applied.list)}return{ok:true,state:snapshot()}}
