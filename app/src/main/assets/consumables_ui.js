...
window.consConfirmFinishActual=function(){
 ...
 try{
  ...
  if(typeof save==='function')save();closeModal();alert('Actual Materials finished and locked. Total material cost: OMR '+Number(x.totalCost||0).toFixed(3));
 }catch(e){alert(String(e?.message||e))}
};
