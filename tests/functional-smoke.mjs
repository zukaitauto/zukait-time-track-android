...
assert.ok(html.includes('v74_updates.js?v=104'), 'Supervisor final asset must use the current V104 cache-busting revision');
assert.ok(html.includes("root.dataset.supervisorRuntime='v104'"), 'Supervisor runtime must identify the current V104 surface');
assert.ok(html.includes('v104SupervisorRuntimeAuthority'), 'Supervisor runtime must use the V104 final authority');
