...
assert.match(updates,/const scheduleWorkers=\(\)=>\{[\s\S]*?document\.visibilityState==='visible'\?3000:30000/,'live worker counts must use visibility-aware refresh cadence');
