...
const required=['tests/architecture-v2.mjs','tests/v2-work-events.mjs','tests/v2-work-rules.mjs','tests/v2-reconnect-shadow-readonly.mjs','tests/v2-reconnect-authority.mjs','tests/v2-authority-adapter.mjs','tests/v2-reconcile-runtime.mjs','tests/v2-pilot-activation.mjs','tests/v2-data-paths.mjs','tests/v2-job-workflow.mjs','tests/v2-spare-parts.mjs','tests/v2-notification-rules.mjs','tests/v2-reports.mjs','tests/v2-scale-benchmark.mjs','tests/v2-bounded-pagination-cursors.mjs','tests/v2-event-write-idempotency.mjs','tests/v2-multidevice-conflict-matrix.mjs','tests/v2-server-calendar-leave-authority.mjs','tests/v2-one-active-session-authority.mjs','tests/v2-delayed-replay-authority.mjs','tests/v2-server-data-adapter.mjs','tests/v2-sql-migration-integrity.mjs','tests/v2-sql-delimiters.mjs','tests/v2-queue-conflict-quarantine.mjs','tests/v2-id001-auto-stop-authority.mjs','tests/v2-assignment-authority.mjs','tests/v2-leave-projection-authority.mjs','tests/v2-calendar-projection-authority.mjs'];
