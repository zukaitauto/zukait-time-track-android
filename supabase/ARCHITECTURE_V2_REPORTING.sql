...
begin;
create or replace function public.zukait_v2_report_page(p_report text,p_before timestamptz default null,p_limit integer default 100,p_filters jsonb default '{}'::jsonb)
...
language sql stable security invoker set search_path=public as $$
 ...
 where (p_before is null or e.server_time<p_before) and (
  q.report='AUDIT' or
